namespace bom_of_teckla_meterials
{
    ...
    class Program
    {
        ...
        public static void CreatePdfFromList(List<MaterialItem> Items, string filePath)
        {
            ...
            //    // Iterate through the list and add each item to the table
            //    foreach (var material in Items)
            //    {
            //        table.AddCell(material.Profile);
            //        table.AddCell(material.Grade);
            //        table.AddCell(material.Qty);
            //        table.AddCell(material.Length);
            //        table.AddCell(material.Area_in2);
            //        table.AddCell(material.Weight);
            //        Total_length += ParseMeasurementToInches(material.Length);
            //        total_area += double.Parse(material.Area_in2);
            //        total_weight += double.Parse(material.Weight)*double.Parse(material.Qty);
            //    }
            //    // Add headers
            //    table.AddCell("total");
            //    table.AddCell("");
            //    table.AddCell("");
            //    table.AddCell(Total_length.ToString());
            //    table.AddCell(total_area.ToString());
            //    table.AddCell(total_weight.ToString());
            //    for (int i = 0;i<6;i++)
            //        table.AddCell("________");
            //}
